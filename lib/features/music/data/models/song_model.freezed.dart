...
class _$SongImpl implements _Song {
  ...
  @override
  String toString() {
    return 'Song(id: $id, title: $title, artist: $artist, album: $album, duration: $duration, imageUrl: $imageUrl, audioUrl: $audioUrl)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, title, artist, album, duration, imageUrl, audioUrl);
...
abstract class _Song implements Song {
  const factory _Song(
      ...
      final String imageUrl,
      final String audioUrl}) = _$SongImpl;
